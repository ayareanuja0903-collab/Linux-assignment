...
#Check the cpu usage based on the current usage and send the email to gmail using the function using the condition on 30% threshold with if condition
